      ...
      <div>
            ...
            <div className="fixed inset-0 z-40 flex">
              ...
              >
                <Dialog.Panel className="relative flex w-full max-w-xs flex-1 flex-col bg-white">
                  ...
                  <div className="h-0 flex-1 overflow-y-auto pt-5 mt-12 pb-4">
                  ...
                  <div className="flex flex-shrink-0 border-t border-gray-200 p-4">
                    <a href="" className="group block flex-shrink-0">
                      <div className="flex items-center">
                        ...
                        <div className="ml-3">
                          <p className="text-base font-medium text-gray-700 group-hover:text-gray-900">João Gerente</p>
        ...
        <div className="hidden md:fixed md:inset-y-0 md:flex md:w-64 md:flex-col">
          ...
          <div className="flex min-h-0 flex-1 flex-col border-r border-gray-200 bg-white">
            <div className="flex flex-1 flex-col overflow-y-auto mt-12 pt-5 pb-4">
              <nav className="mt-5 flex-1 space-y-1 bg-white px-2">
                {navigation.map((item) => (
                  <a
                    key={item.name}
                    href={item.href}
                    onClick={() => setOptionClicked(item.href)}
                    className={classNames(
            ...
            <div className="flex flex-shrink-0 border-t border-gray-200 p-4">
              <a href="" className="group block w-full flex-shrink-0">
                <div className="flex items-center">
                  ...
                  <div className="ml-3">
                    <p className="text-sm font-medium text-gray-700 group-hover:text-gray-900">João Gerente</p>
